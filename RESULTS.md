...
| GraphHopper 11 CH | 48 s | 3,030,503,424 B (2.82 GiB) | 139,506,233 B (133.0 MiB) | High-speed cross-city route OK |
...
- A 4 GiB machine is too close to GraphHopper's measured build peak and leaves little operating-system headroom. Build with 8-12 GiB even if runtime later proves smaller.
...
GraphHopper showed run-to-run peak-memory variation. Another valid build
completed in 50 seconds and peaked at 3,744,653,312 bytes (3.49 GiB), with the
same graph size. Capacity planning should use this higher observed peak.
